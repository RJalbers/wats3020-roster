...
class Course {
    ...
    addStudent() {
       let name = prompt('Enter student full name:', 'Ryan Albers');
       let email = prompt('Enter student email:','RJlabers@gmail.com');
    ...
    setTeacher() {
        let name = prompt('Enter full teacher name:', 'Mel Gibson');
        let email = prompt('Enter teacher email:', 'melG@gmail.com')
